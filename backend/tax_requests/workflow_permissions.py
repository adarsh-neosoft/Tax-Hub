...
FK_FIELDS = frozenset({"company", "currency", "particular", "nature_of_service", "form_146_type", "country", "vendor_status", "bank_ifsc_code", "rbi_purpose_code", "rbi_sub_code", "external_ca", "tds_section",})
